...
if __name__ == "__main__":
    input_directories = [
        "repo/datasets/all/min/csv",
        "repo/datasets/all/mid/csv",
        "repo/datasets/all/max/csv",
    ]
    output_directories = [
        "repo/datasets/all/min/bert",
        "repo/datasets/all/mid/bert",
        "repo/datasets/all/max/bert",
    ]
    ...
    generate_balanced_dataset_and_embeddings(labels, input_directory, output_file, num_samples_per_class, batch_size)
