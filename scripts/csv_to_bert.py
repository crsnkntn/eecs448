...
# Configuration
input_directory = "repo/datasets/all/max/csv"  # Update this path to your input directory
output_directory = "repo/datasets/all/ma/bert"  # Update this path to your output directory
